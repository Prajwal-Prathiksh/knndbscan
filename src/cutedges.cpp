...
void update_cutedges(point_int n0, point_int ISTART, const vector<point_int> R,
                     const map<point_int, int> label, const point_int* JA,
                     const float* A, vector<edge_int>& crossE) {
