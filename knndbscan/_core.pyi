...
def knndbscan(
    ...
    This function implements a variant of DBSCAN that uses a k-nearest neighbors (kNN)
    graph for efficient density-based clustering. It supports parallel execution using OpenMP and can be used in distributed environments with MPI.
    ...
    Args:
        ...
        minPts (int): Minimum number of points required to form a dense region (core
            point).
    ...
    Raises:
        RuntimeError: If MPI initialization fails or if input arrays have invalid shapes/
        sizes.
